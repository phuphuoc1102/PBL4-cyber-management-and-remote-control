...
public class ChatPanel extends JPanel implements Runnable {
    ...
    private void initComponents() {
        ...
        this.send_label.setIcon(new ImageIcon(this.getClass().getResource("/images/send_icon.png")));
        ...
        this.file_label.setIcon(new ImageIcon(this.getClass().getResource("/images/file_icon.png")));
...
//        this.loader_label.setIcon(new ImageIcon(this.getClass().getResource("/images/loader_icon2.gif")));
